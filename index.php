      ...
      <div class="container">
        <nav class="nav">
          ...
          <div class="nav__login">
            <a href="./login/login.php" class="icon__item">
              Login
            </a>
          </div>
        </nav>
            ...
            <ul class="glide__slides">
              <li class="glide__slide">
                <div class="testimonial__box">
                  ...
                  <p>CBAS is to help the administrators, in order to know the attendance data of their employees.
                  </p>
              ...
              <li class="glide__slide">
                <div class="testimonial__box">
                  ...
                  <p>This Website helps Users to get daily or monthly information about Time of
              ...
              <li class="glide__slide">
                <div class="testimonial__box">
                  ...
                  <p>Using the employee and students card number for taking their attendance not just for passage.
                  </p>
                </div>
              </li>
            </ul>
